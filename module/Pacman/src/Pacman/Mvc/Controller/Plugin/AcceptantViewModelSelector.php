...
namespace Pacman\Mvc\Controller\Plugin;
 ...
 *
 * @see https://github.com/zendframework/zf2/pull/2405
 */
class AcceptantViewModelSelector extends AbstractPlugin
{
    ...
    public function __invoke(array $matchAgainst = null, $returnMatchedAcceptTypeOnly = false)
    {
        ...
        if ((!$matchAgainst && !$this->defaultMatchString) ||
            !$headers->has('accept')
        ) {
